...
1. Explain the difference between `RDBMS` and `SQL`.
    Relational Database Management System is the system, SQL is the language used to manipulate/manage the system.

1. Why do tables need a `primary key`?
    primary keys are used as foreign keys to create relationships between multiple tables.

1. What is the name given to a table column that references the primary key on another table.
    foreign key.

1. What do we need in order to have a _many to many_ relationship between two tables.
    a bridge table that holds foreign keys for both connecting tables.
